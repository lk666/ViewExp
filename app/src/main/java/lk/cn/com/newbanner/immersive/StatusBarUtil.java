...
public class StatusBarUtil {
    ...
    //    }
    //
    //    public static void darkMode(Activity activity, int color, @FloatRange(from = 0.0, to =
    // 1.0)
    //            float alpha) {
    ...
    //     * 设置状态栏darkMode,字体颜色及icon变黑(目前支持MIUI6以上,Flyme4以上,Android M以上)
    //     */
    //    public static void darkMode(Window window, int color, @FloatRange(from = 0.0, to = 1.0)
    // float
    //            alpha) {
    //        if (isFlyme4Later()) {
